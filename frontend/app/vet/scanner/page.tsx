                    ...
                    <form onSubmit={handleManualSubmit} className="space-y-4 py-8">
                        <div>
                            ...
                            <input
                                ...
                                className="block w-full rounded-md border-0 py-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4"
                                value={petId}
